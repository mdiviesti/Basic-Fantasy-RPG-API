class SpellsData {
    getSpells() {
        return [{
            ...
            "table": {
                "die": "d20",
                "headers": ["d20", "behavior"],
                "values": [["1–2",
                    "Attack caster with melee or ranged weapons (or close with caster if attack is not possible)."],
                    ["3–4", "Act normally."], ["5–10", "Do nothing but babble incoherently."],
                    ["11–14", "Flee away from caster at top possible speed."], ["15–20", "Attack nearest creature."]]
            }
        }, {
            ...
            "table": {
                "die": "d%",
                "headers": ["d%", "Incarnation"],
                "values": [["01–02", "Bugbear"], ["03–17", "Dwarf"], ["18–28", "Elf"], ["29", "Gnoll"],
                    ["30–39", "Gnome"], ["40–44", "Goblin"], ["45–63", "Halfling"], ["64–88", "Human"],
                    ["89–92", "Kobold"], ["93", "Lizard Man"], ["94–98", "Orc"], ["99", "Troglodyte"],
            ...
            "table": {
                "die": "d%",
                "headers": ["Familiarity", "On Target", "Off Target", "Similar Area", "Mishap"],
                "values": [["Very familiar", "01-97", "98-99", "100", "-"],
